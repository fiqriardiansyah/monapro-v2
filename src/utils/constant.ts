...
export const AWS_PATH = "https://s3.ap-southeast-1.amazonaws.com";

export const KEY_UPLOAD_FILE = "upload-file-";

export const MAXIMAL_NON_JUSTIFICATION = 20000000;
...
export const SPONSORSHIP_TYPE = 1;
